  ...
  return (
    <div className="space-y-4">
      ...
      <form
        ...
        className="border-bordurewarm-tertiary dark:border-encre/20 flex flex-wrap items-center gap-2 rounded-xl border bg-white p-3"
      >
        <input
          name="ids"
          placeholder="id1,id2,id3"
          className="border-bordurewarm-tertiary dark:border-encre/20 min-w-[280px] rounded-lg border px-2 py-1.5 text-sm"
        />
        <input
          name="bulkStatus"

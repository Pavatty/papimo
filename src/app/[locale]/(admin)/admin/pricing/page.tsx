    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        {packs.map((pack) => (
          <article
            key={pack.id}
            className={`border-bordurewarm-tertiary dark:border-encre/20 rounded-xl border bg-white p-5 ${pack.is_recommended ? "ring-bleu/30 ring-2" : ""} ${pack.is_active ? "" : "opacity-50"}`}
          >
            <div className="mb-3 flex items-start justify-between gap-3">
              <div>
                <p className="text-encre dark:text-creme text-lg font-semibold">
                  {pack.label_fr}
                </p>
            ...
            <dl className="text-encre dark:text-creme space-y-1.5 text-sm">
              <div className="flex justify-between">
                <dt className="text-encre/70 dark:text-creme/70">
                  Prix mensuel
                </dt>
              ...
              <div className="flex justify-between">
                <dt className="text-encre/70 dark:text-creme/70">Statut</dt>
      ...
      <p className="text-encre/70 dark:text-creme/70 mt-2 text-xs">
        Modification des prix : ouvrir{" "}
        <code className="bg-creme-pale dark:bg-encre/60 rounded px-1">{`/${locale}/admin/reglages`}</code>{" "}
